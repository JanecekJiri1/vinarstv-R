    ...
    <div className="about">
      <div className="aboutContainer">
        ...
        <p className="aboutDescription">
          ...
          adipisicing elit. Atque tempore nostrum molestiae beatae illum laborum veritatis totam, quas modi facilis eligendi sequi harum tempora
          impedit debitis! Modi dignissimos voluptatem nulla.
        </p>
      </div>
    </div>
  );
